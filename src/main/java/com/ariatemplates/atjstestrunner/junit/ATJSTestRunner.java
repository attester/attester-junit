...
public class ATJSTestRunner extends Runner {
    ...
    private ATJSTestRunnerProcess nodeProcess;
    ...
    public ATJSTestRunner(Class<?> testClass) {
        this(testClass.getName(), getConfigFile(testClass));
    }

    public ATJSTestRunner(String rootTestName, String configFile) {
    ...
    private void checkNodeStarted() {
        ...
        nodeProcess = new ATJSTestRunnerProcess(cmdLine.toArray(new String[] {}));
    }
